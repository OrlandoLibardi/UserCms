...
class UserController extends Controller
{
    ...
    */
    public function index(Request $request) {
        ...
        $user  = false;
        return view('viewUserCms::index',compact('data', 'roles', 'user'));
    ...
    */
    ...
    {
        $user = User::find($id);
        return view('viewUserCms::show', compact('user'));
    }
    ...
    */
    public function edit($id)
    {
        ...
        return view('viewUserCms::index',compact('user','roles','userRole'));
    }
